...
public sealed class UnauthenticatedPairsTests : IAsyncLifetime
{
    ...
    public async Task Asserts_PairsDefaultListing_JsonResponseDeserialization()
    {
        ...
        var pairsListing = await new CryptoWatchRestApi(_httpClientFactory).Pairs
            .ListAsync();
    ...
    public async Task Asserts_PairsSpecificAmountListing_JsonResponseDeserialization()
    {
        ...
        var pairsListing = await new CryptoWatchRestApi(_httpClientFactory).Pairs.ListAsync(items);
        ...
        Asserts_PairsListingWithCursor_JsonResponseDeserialization()
    {
        ...
        var pairsListing = await new CryptoWatchRestApi(_httpClientFactory).Pairs.ListAsync(cursor);
        ...
        Asserts_PairsSpecificAmountWithCursorListing_JsonResponseDeserialization()
    {
        ...
        var pairsListing = await new CryptoWatchRestApi(_httpClientFactory).Pairs.ListAsync(items, cursor);
    ...
    public async Task Asserts_PairsDefaultDetail_JsonResponseDeserialization()
    {
        ...
        var pairDetails = await new CryptoWatchRestApi(_httpClientFactory).Pairs.DetailsAsync(pair);
